...
Every one of the 13 prior experiments was a single-stock directional bet on some flavor of breakout, gap, fade, or catch-up -- all of which failed out-of-sample -- so a market-neutral pairs mechanism represents a genuine structural break rather than a repackaged variant. Its rationale (idiosyncratic, sector-catalyst-free divergence between correlated peers being liquidity noise that gets arbitraged back) is specific, falsifiable, and mechanistically distinct from anything tried so far, making it the strongest combination of theoretical grounding and novelty.
