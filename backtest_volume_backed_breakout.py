"""
Standalone backtest of the VolumeBackedBreakoutStrategy prototype
(strategies/volume_backed_breakout.py) against the Nifty 500 universe,
...
the shared conventions.
    ...
    python backtest_volume_backed_breakout.py [--years=N] [--limit=N]
...
from strategies.volume_backed_breakout import VolumeBackedBreakoutStrategy
...
def main():
    ...
    strategy = VolumeBackedBreakoutStrategy()
    ...
    months = years * 12
    print("\n" + "=" * 70)
    print(f"VOLUME-BACKED BREAKOUT -- {len(eligible_symbols)} symbols, {period} backtest")
    print("=" * 70)
